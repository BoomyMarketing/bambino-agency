...
<head>
  ...
  <title>SEO Agency {name}, {state} | Bambino</title>
  <link rel="icon" type="image/x-icon" href="/favicon.ico" />
  <link rel="apple-touch-icon" href="/apple-touch-icon.png" />
  <meta name="description" content="Top-rated SEO agency in {name}, {state}. We help {name} businesses rank higher on Google, generate qualified leads, and outrank competitors. Free audit." />
