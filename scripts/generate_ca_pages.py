#!/usr/bin/env python3
"""Generate Canadian city SEO agency pages — /ca/{city}/seo-agency/index.html"""
...
CITIES = {
    "toronto": {
        ...
        "stats": [
            {"num": "2.9M", "label": "City population"},
            {"num": "$450B", "label": "Metro GDP"},
            {"num": "97K+", "label": "Active Toronto businesses"},
            {"num": "#1", "label": "Largest Canadian city"},
        ],
    ...
    "vancouver": {
        ...
        "stats": [
            {"num": "675K", "label": "City population"},
            {"num": "$160B", "label": "Metro GDP"},
            {"num": "80K+", "label": "Active Vancouver businesses"},
            {"num": "#3", "label": "Largest Canadian metro"},
        ],
    ...
    "calgary": {
        ...
        "stats": [
            ...
            {"num": "$130B", "label": "Metro GDP"},
            {"num": "60K+", "label": "Active Calgary businesses"},
            {"num": "#1", "label": "Fastest-growing major CA city"},
        ],
    ...
    "edmonton": {
        ...
        "stats": [
            {"num": "1.0M", "label": "City population"},
            {"num": "$110B", "label": "Metro GDP"},
            {"num": "50K+", "label": "Active Edmonton businesses"},
            {"num": "#5", "label": "Largest Canadian city"},
        ],
    ...
    "ottawa": {
        ...
        "stats": [
            {"num": "1.1M", "label": "City population"},
            {"num": "$90B", "label": "Metro GDP"},
            {"num": "40K+", "label": "Active Ottawa businesses"},
            {"num": "#1", "label": "Highest median household income among major CA cities"},
        ],
    ...
    "montreal": {
        ...
        "stats": [
            {"num": "2.1M", "label": "City population"},
            {"num": "$230B", "label": "Metro GDP"},
            {"num": "85K+", "label": "Active Montreal businesses"},
            {"num": "#2", "label": "Largest Canadian city"},
        ],
    ...
    "winnipeg": {
        ...
        "stats": [
            {"num": "780K", "label": "City population"},
            {"num": "$65B", "label": "Metro GDP"},
            {"num": "35K+", "label": "Active Winnipeg businesses"},
            {"num": "#7", "label": "Largest Canadian city"},
        ],
    ...
    "quebec-city": {
        ...
        "stats": [
            {"num": "580K", "label": "City population"},
            {"num": "$55B", "label": "Metro GDP"},
            {"num": "28K+", "label": "Active Quebec City businesses"},
            {"num": "#1", "label": "Safest major Canadian city"},
        ],
    ...
    "hamilton": {
        ...
        "stats": [
            {"num": "580K", "label": "City population"},
            {"num": "$45B", "label": "Metro GDP"},
            {"num": "25K+", "label": "Active Hamilton businesses"},
            {"num": "#8", "label": "Largest Canadian city"},
        ],
    ...
    "kitchener": {
        ...
        "stats": [
            {"num": "270K", "label": "City population"},
            {"num": "$58B", "label": "Tri-city metro GDP"},
            {"num": "1,000+", "label": "Tech companies in region"},
            {"num": "#1", "label": "Canada's fastest-growing tech corridor"},
        ],
...
def build_page(slug, c):
    ...
    related_links = "\n".join([
        f'            <li><a href="https://bambinoagency.com/ca/{rc}/seo-agency">{rn} SEO Agency</a></li>'
...
<head>
  ...
  <meta property="og:description" content="Top-rated SEO agency serving {name}, {province}. Proven results: 400+ clients, 97% retention, $25M+ revenue generated. Get a free SEO audit today." />
  <meta property="og:url" content="https://bambinoagency.com/ca/{slug}/seo-agency" />
  ...
  {{
    ...
    "@graph": [
      {{
        ...
        "description": "Top-rated SEO agency serving {name}, {province}. Specialists in organic growth, technical SEO, content marketing, and paid media for Canadian businesses.",
        "address": {{
          "@type": "PostalAddress",
      ...
      {{
        ...
        "itemListElement": [
          ...
          {{"@type": "ListItem", "position": 3, "name": "{name}", "item": "https://bambinoagency.com/ca/{slug}/seo-agency"}}
        ]
      }},
      {{
        "@type": "FAQPage",
        "mainEntity": [
          {{
            ...
            "acceptedAnswer": {{"@type": "Answer", "text": "SEO services in {name} typically range from CAD $1,700–$7,500/month depending on competition level, target keywords, and service scope. Bambino's {name} packages start at CAD $1,700/month for foundational SEO and scale to CAD $7,500/month for full-service campaigns. We also offer one-time technical audits from CAD $800. Unlike most Canadian agencies, we display transparent pricing upfront."}}
          }},
          {{
            "@type": "Question",
          ...
          {{
            ...
            "acceptedAnswer": {{"@type": "Answer", "text": "Yes. Bambino serves clients across Canada, the US, and the UK. Our {name} clients work with dedicated account managers via video call, and all reporting is delivered in a Canadian timezone-friendly format. We have extensive experience with Canadian search trends, Google Business Profile, and English-Canadian content strategy."}}
          }},
          {{
            "@type": "Question",
            "name": "What SEO services do you offer in {name}?",
            "acceptedAnswer": {{"@type": "Answer", "text": "Our {name} SEO services include: technical SEO audits, on-page optimisation, local SEO and Google Business Profile management, content strategy and blog production, link building from authoritative Canadian publications, Google Ads management, CRO, and monthly analytics reporting. We cover the full search marketing stack."}}
          }},
          {{
            "@type": "Question",
            "name": "What industries do you serve in {name}?",
            "acceptedAnswer": {{"@type": "Answer", "text": "We serve a wide range of {name} industries including {', '.join(industries[:5])} and more. Our sector specialists develop keyword strategies and content tailored to your specific industry's search behaviour, competition level, and buyer intent."}}
          }},
          {{
            "@type": "Question",
            "name": "What makes Bambino different from other {name} SEO agencies?",
            "acceptedAnswer": {{"@type": "Answer", "text": "Three things: First, transparent CAD pricing — unlike most Canadian agencies, we publish our rates upfront. Second, E-E-A-T content — Google's quality rater guidelines reward experience and expertise, so we build content that demonstrates both. Third, AI search readiness — we optimise for Google AI Overviews, ChatGPT, and Perplexity alongside traditional rankings."}}
          }},
          {{
            "@type": "Question",
  ...
  <section id="hero" aria-label="SEO Agency {name}">
    ...
    <div class="container">
      <div class="hero-content">
        ...
        <p class="hero-label">SEO Agency — {name}, {province}</p>
        <h1 class="hero-h1">Top-Rated SEO Agency in {name}, {province} — Grow Your Business Faster</h1>
        ...
        <div class="hero-actions">
          ...
          <a href="#pricing" class="btn-outline">View CAD Pricing</a>
        </div>
    ...
    <div class="container">
      <div class="market-grid">
        <div>
          ...
          <h2 class="section-title" id="market-title">{name} Search Landscape</h2>
          <p class="section-sub">Understanding the {metro} market is the foundation of every Bambino SEO strategy. We combine local search data with industry benchmarks to identify exactly where your opportunity lies.</p>
          <div class="eeat-box" style="margin-top:1.5rem">
            <p><strong>Our {name} track record:</strong> {eeat_stat}. We track every ranking, every lead, and every dollar — so you see the ROI clearly.</p>
          </div>
        </div>
...
{stats_cards}
  ...
  <section id="services" aria-labelledby="services-title">
    <div class="container">
      ...
      <h2 class="section-title" id="services-title">SEO &amp; Digital Marketing Services in {name}</h2>
      <p class="section-sub">From technical foundations to content amplification — our {name} SEO service stack is built to win on Google's evolving algorithm, including AI Overviews and local pack results.</p>
      <div class="svc-grid">
        <div class="svc-card">
          <span class="svc-lbl">Core SEO</span>
          <h3>Technical SEO Audit</h3>
          <p>Deep crawl analysis, Core Web Vitals optimisation, indexability review, and structured data implementation — the foundation every {name} site needs.</p>
        </div>
        <div class="svc-card">
          <span class="svc-lbl">Core SEO</span>
          <h3>Local SEO &amp; Google Business Profile</h3>
          <p>Dominate {name} local pack results. We optimise your GBP, build local citations, and implement local schema to drive in-store and in-office visits.</p>
        </div>
        <div class="svc-card">
          <span class="svc-lbl">Content</span>
          <h3>Content Strategy &amp; Blog Production</h3>
          <p>Keyword-researched, E-E-A-T compliant content that ranks in {name} and converts visitors into enquiries. Monthly editorial calendar included.</p>
        </div>
        <div class="svc-card">
          <span class="svc-lbl">Authority</span>
          <h3>Link Building &amp; Digital PR</h3>
          <p>Earn high-authority backlinks from Canadian publications and industry media. White-hat outreach with transparent reporting on every link acquired.</p>
        </div>
        <div class="svc-card">
          <span class="svc-lbl">Paid Media</span>
          <h3>Google Ads Management</h3>
          <p>PPC campaigns targeting {name} buyers at every stage of the funnel — search, Performance Max, and Local campaigns — managed for maximum ROAS.</p>
        </div>
        <div class="svc-card">
          <span class="svc-lbl">AI Search</span>
          <h3>GEO &amp; AI Overview Optimisation</h3>
          <p>Optimise your content to appear in Google AI Overviews, ChatGPT, and Perplexity responses for {name}-relevant queries. The frontier of search visibility.</p>
        </div>
        <div class="svc-card">
          <span class="svc-lbl">Conversion</span>
          <h3>Conversion Rate Optimisation</h3>
          <p>A/B testing, landing page optimisation, and UX improvements that turn more of your {name} organic traffic into qualified leads and paying clients.</p>
        </div>
        <div class="svc-card">
          <span class="svc-lbl">Analytics</span>
          <h3>GA4 &amp; Reporting</h3>
          <p>Custom GA4 dashboards, monthly performance reports, and quarterly strategy reviews. Full transparency on what's working and what's next.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="why" aria-labelledby="why-title">
    <div class="container">
      ...
      <h2 class="section-title" id="why-title">Why {name} Businesses Choose Bambino</h2>
      <div class="why-grid reveal">
        <div class="why-card">
          <h3>Transparent CAD Pricing</h3>
          <p>Unlike most Canadian agencies that hide their rates, we publish clear CAD pricing. You know exactly what you're paying and what you're getting — no surprises on invoice day.</p>
        </div>
        <div class="why-card">
          <h3>Data-Led Strategy</h3>
          <p>Every recommendation is backed by live keyword data, competitor analysis, and actual search intent research — not hunches. We show you the evidence before we act.</p>
        </div>
        <div class="why-card">
          <h3>AI Search Ready</h3>
          <p>We optimise for Google AI Overviews, ChatGPT, and Perplexity alongside traditional rankings — preparing your {name} business for the next era of search.</p>
        </div>
        <div class="why-card">
          <h3>No Contracts. Real Results.</h3>
          <p>Month-to-month engagements with 30 days' notice to cancel. We earn your business every month through measurable results, not legal lock-in.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="process" aria-labelledby="process-title">
    <div class="container">
      ...
      <h2 class="section-title" id="process-title">How We Grow {name} Businesses on Google</h2>
      <div class="process-steps">
        <div class="step">
          <div class="step-num">1</div>
          <h4>Discovery &amp; Audit</h4>
          <p>30-minute strategy call + full technical and keyword audit of your {name} site — identifying gaps and quick wins.</p>
        </div>
        <div class="step">
          <div class="step-num">2</div>
          <h4>Strategy Build</h4>
          <p>Custom 12-month SEO roadmap based on your {name} market, competition, and revenue targets.</p>
        </div>
        <div class="step">
          <div class="step-num">3</div>
          <h4>On-Page &amp; Technical</h4>
          <p>Fix crawlability, site speed, schema, and on-page optimisation — the foundation everything else builds on.</p>
        </div>
        <div class="step">
          <div class="step-num">4</div>
          <h4>Content &amp; Links</h4>
          <p>Publish E-E-A-T content targeting {name} buyer keywords, and earn authority backlinks from Canadian publications.</p>
        </div>
        <div class="step">
          <div class="step-num">5</div>
          <h4>Report &amp; Refine</h4>
          <p>Monthly ranking and lead reports with plain-English commentary. Quarterly strategy reviews to stay ahead of algorithm changes.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="results" aria-labelledby="results-title">
    <div class="container">
      ...
      <h2 class="section-title" id="results-title">What Our Clients Achieve</h2>
      <div class="results-grid reveal">
        <div class="result-card">
          <span class="result-stat">+312%</span>
          <p class="result-desc">Organic traffic growth</p>
          <p class="result-detail">B2B SaaS firm, 8 months — from 1,200 to 4,900 monthly organic visitors through technical SEO and content production.</p>
        </div>
        <div class="result-card">
          <span class="result-stat">-58%</span>
          <p class="result-desc">Cost-per-lead reduction</p>
          <p class="result-detail">Professional services firm shifted budget from PPC to organic — monthly lead costs dropped from CAD $340 to CAD $144 within 6 months.</p>
        </div>
        <div class="result-card">
          <span class="result-stat">4.1×</span>
          <p class="result-desc">Return on SEO investment</p>
          <p class="result-detail">E-commerce brand, 12 months — CAD $3,800/month SEO retainer generating CAD $15,600/month in attributable organic revenue.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="industries" aria-labelledby="industries-title">
    <div class="container">
      ...
      <h2 class="section-title" id="industries-title">Sector Expertise Across {name}</h2>
      <p class="section-sub">We serve businesses across {neighborhoods} and the wider {metro}. Our sector specialists know how buyers in each industry search, compare, and convert.</p>
      <div class="ind-pills">
{industry_pills}
      </div>
    </div>
  ...
  <section id="pricing" aria-labelledby="pricing-title">
    <div class="container">
      <span class="section-label">Transparent CAD Pricing</span>
      <h2 class="section-title" id="pricing-title">SEO Agency Pricing for {name} Businesses</h2>
      <p class="section-sub">Clear Canadian dollar pricing — no hidden fees, no long-term contracts. Only 33% of Canadian agencies publish their rates; we do, because transparency builds trust.</p>
      <div class="pricing-grid">

        <!-- Starter -->
        <div class="price-card">
          <p class="plan-name">Starter</p>
          <p class="plan-price"><sup>CAD $</sup>1,700</p>
          <p class="plan-period">per month</p>
          <p class="plan-desc">Ideal for small {name} businesses and startups building their first SEO foundation.</p>
          <ul class="plan-features">
            <li class="plan-feature"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>Technical SEO audit</li>
            <li class="plan-feature"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>On-page optimisation (10 pages)</li>
            <li class="plan-feature"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>2 blog posts/month</li>
            <li class="plan-feature"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>Google Business Profile optimisation</li>
            <li class="plan-feature"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>Monthly ranking report</li>
          </ul>
          <a href="https://bambinoagency.com/contact" class="btn-outline" style="width:100%;justify-content:center">Get Started</a>
        </div>

        <!-- Growth (featured) -->
        <div class="price-card featured">
          <p class="plan-name">Growth</p>
          <p class="plan-price"><sup>CAD $</sup>3,500</p>
          <p class="plan-period">per month</p>
          <p class="plan-desc">Our most popular package for {name} businesses ready to compete seriously for top Google rankings.</p>
          <ul class="plan-features">
            <li class="plan-feature"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>Everything in Starter</li>
            <li class="plan-feature"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>4 blog posts/month</li>
            <li class="plan-feature"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>Link building (5 links/month)</li>
            <li class="plan-feature"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>Competitor gap analysis</li>
            <li class="plan-feature"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>GA4 dashboard + monthly review call</li>
            <li class="plan-feature"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>LinkedIn Ads management</li>
          </ul>
          <a href="https://bambinoagency.com/contact" class="btn-orange" style="width:100%;justify-content:center">Get Started</a>
        </div>

        <!-- Scale -->
        <div class="price-card">
          <p class="plan-name">Scale</p>
          <p class="plan-price"><sup>CAD $</sup>7,500</p>
          <p class="plan-period">per month</p>
          <p class="plan-desc">For established {name} businesses targeting market leadership and multi-channel organic dominance.</p>
          <ul class="plan-features">
            <li class="plan-feature"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>Everything in Growth</li>
            <li class="plan-feature"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>8 blog posts + content strategy</li>
            <li class="plan-feature"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>Link building (12 links/month)</li>
            <li class="plan-feature"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>CRO &amp; landing page optimisation</li>
            <li class="plan-feature"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>Digital PR &amp; media outreach</li>
            <li class="plan-feature"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>GEO / AI search optimisation</li>
          </ul>
          <a href="https://bambinoagency.com/contact" class="btn-outline" style="width:100%;justify-content:center">Get Started</a>
        </div>
        ...
        <div class="price-card">
          ...
          <p class="plan-price" style="font-size:1.8rem">Custom</p>
          <p class="plan-period">bespoke engagement</p>
          <p class="plan-desc">Tailored solutions for large {name} organisations, multi-location businesses, and complex SEO challenges.</p>
          <ul class="plan-features">
            <li class="plan-feature"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>Everything in Scale</li>
            <li class="plan-feature"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>Dedicated account director</li>
            <li class="plan-feature"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>Multi-location SEO management</li>
            <li class="plan-feature"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>Custom integrations &amp; reporting</li>
            <li class="plan-feature"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>Quarterly executive briefings</li>
          </ul>
          <a href="https://bambinoagency.com/contact" class="btn-outline" style="width:100%;justify-content:center">Contact Us</a>
        </div>
  ...
  <section id="faq" aria-labelledby="faq-title">
    <div class="container">
      ...
      <h2 class="section-title" id="faq-title">FAQ — SEO Agency in {name}</h2>
      <div class="faq-list">
        <div class="faq-item">
          <button class="faq-q" aria-expanded="false">How much does SEO cost in {name}? <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
          <div class="faq-ans"><p>SEO services in {name} typically range from CAD $1,700–$7,500/month depending on competition level, target keywords, and service scope. Bambino's {name} packages start at CAD $1,700/month for foundational SEO and scale to CAD $7,500/month for full-service campaigns. We also offer one-time technical audits from CAD $800. Unlike most Canadian agencies, we display transparent pricing upfront.</p></div>
        </div>
        <div class="faq-item">
          <button class="faq-q" aria-expanded="false">How long does SEO take to show results in {name}? <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
          <div class="faq-ans"><p>Most {name} businesses see measurable ranking improvements within 90 days and significant traffic growth within 6 months. Highly competitive markets like {name} may take 6–12 months for page-one dominance on head terms. Local and long-tail keywords typically rank faster — often within 60–90 days.</p></div>
        </div>
        <div class="faq-item">
          <button class="faq-q" aria-expanded="false">Do you work with businesses outside the UK? <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
          <div class="faq-ans"><p>Yes. Bambino serves clients across Canada, the US, and the UK. Our {name} clients work with dedicated account managers via video call, and all reporting is delivered in a Canadian timezone-friendly format. We have extensive experience with Canadian search trends, Google Business Profile, and English-Canadian content strategy.</p></div>
        </div>
        <div class="faq-item">
          <button class="faq-q" aria-expanded="false">What SEO services do you offer in {name}? <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
          <div class="faq-ans"><p>Our {name} SEO services include: technical SEO audits, on-page optimisation, local SEO and Google Business Profile management, content strategy and blog production, link building from authoritative Canadian publications, Google Ads management, CRO, and monthly analytics reporting.</p></div>
        </div>
        <div class="faq-item">
          <button class="faq-q" aria-expanded="false">What industries do you serve in {name}? <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
          <div class="faq-ans"><p>We serve a wide range of {name} industries including {", ".join(industries[:5])} and more. Our sector specialists develop keyword strategies and content tailored to your specific industry's search behaviour, competition level, and buyer intent.</p></div>
        </div>
        <div class="faq-item">
          <button class="faq-q" aria-expanded="false">What makes Bambino different from other {name} SEO agencies? <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
          <div class="faq-ans"><p>Three things: First, transparent CAD pricing — unlike most Canadian agencies, we publish our rates upfront. Second, E-E-A-T content — Google's quality rater guidelines reward experience and expertise, so we build content that demonstrates both. Third, AI search readiness — we optimise for Google AI Overviews, ChatGPT, and Perplexity alongside traditional rankings.</p></div>
        </div>
        <div class="faq-item">
          <button class="faq-q" aria-expanded="false">Do you offer a free SEO audit for {name} businesses? <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
          <div class="faq-ans"><p>Yes. We offer a complimentary 30-minute SEO audit call for {name} businesses. We'll review your current rankings, identify technical issues, and outline the top 3 quick-win opportunities — with no obligation to proceed.</p></div>
        </div>
        <div class="faq-item">
  ...
  <section id="related" aria-labelledby="related-title">
    <div class="container">
      ...
      <h2 class="section-title" id="related-title">SEO Agency Services Across Canada</h2>
      <ul class="related-grid">
{related_links}
        <li><a href="https://bambinoagency.com/ca" class="related-card">All Canadian Cities &rarr;</a></li>
      </ul>
    </div>
  </section>
  ...
  <section id="cta" aria-labelledby="cta-title">
    <div class="container">
      <div class="cta-inner">
        <h2 class="cta-title" id="cta-title">Ready to Grow Your {name} Business on Google?</h2>
        <p class="cta-sub">Get a free 30-minute SEO audit — we'll identify your top 3 quick-win opportunities and show you exactly what it would take to reach page one.</p>
        <div style="display:flex;gap:1rem;justify-content:center;flex-wrap:wrap">
          <a href="https://bambinoagency.com/contact" class="btn-orange" style="font-size:1rem;padding:1rem 2.5rem">Get My Free Audit &rarr;</a>
          <a href="#pricing" class="btn-white">View CAD Pricing</a>
        </div>
      </div>
    </div>
  </section>
  ...
  <footer id="footer" role="contentinfo">
    <div class="container">
      <div class="footer-grid">
        <div>
          <p class="footer-brand-logo">Bambino</p>
          <p class="footer-brand-desc">AI-native digital marketing agency. Serving Canada, US &amp; UK. HQ: Manchester, England.</p>
          <a href="https://bambinoagency.com/contact" class="btn-orange" style="font-size:0.88rem;padding:0.7rem 1.6rem">Free SEO Audit &rarr;</a>
        </div>
        <div>
          <p class="footer-col-title">Services</p>
          <ul class="footer-links">
            <li><a href="https://bambinoagency.com/services/seo">SEO Services</a></li>
            ...
            <li><a href="https://bambinoagency.com/services/geo">GEO &amp; AI Search</a></li>
            <li><a href="https://bambinoagency.com/services">All 29 Services &rarr;</a></li>
          </ul>
        </div>
        <div>
          <p class="footer-col-title">Canada</p>
          <ul class="footer-links">
            ...
            <li><a href="https://bambinoagency.com/ca">All Cities &rarr;</a></li>
          </ul>
        </div>
        <div>
      ...
      <div class="footer-bottom">
        <p>&copy; 2026 Bambino Agency Ltd. Registered in England &amp; Wales. All rights reserved.</p>
        <p>+44 161 000 0000 &middot; hello@bambinoagency.com</p>
      </div>
    </div>
  </footer>
...
for slug, city in CITIES.items():
    out_dir = os.path.join(BASE, "ca", slug, "seo-agency")
    os.makedirs(out_dir, exist_ok=True)
    html = build_page(slug, city)
    out_path = os.path.join(out_dir, "index.html")
    with open(out_path, "w", encoding="utf-8") as f:
        f.write(html)
    print(f"OK: /ca/{slug}/seo-agency/")

print(f"\nDone: {len(CITIES)} Canadian city pages generated.")
